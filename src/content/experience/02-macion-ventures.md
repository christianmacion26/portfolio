...
endDate: '2026-05'
isCurrent: false
summary: 'Built a 7-agent venture-incubation pipeline (5 judgment-tier + 2 mechanical) with 10 lifecycle skills and an anti-self-approval governance pattern.'
tags: [agent-pipeline, governance, venture-incubation, prompts]
contributions:
  - label: '7-agent venture-incubation pipeline'
