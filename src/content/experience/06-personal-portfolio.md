...
endDate: "2026-05"
isCurrent: false
summary: "Designed and shipped runnable AI projects end-to-end (RAG, ReAct, MCP, judge-harness, reflection loop, slop gate) and backtested systematic strategies."
...
contributions:
  ...
  - label: "9 reproducible public-data quant projects"
    ...
    proof: "See /projects/ (9 quant projects)"
  - label: "31-gate eval harness methodology"
  ...
  - label: "20+ research paper summaries"
    ...
    proof: "One-page research notes (in research journal)"
proofs:
